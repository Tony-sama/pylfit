            ...
            for complete in [True,False]:
                for verbose in [0,1]:
                    ...
                    with contextlib.redirect_stderr(f):
                        rules, constraints = Synchronizer.fit(dataset=dataset, complete=True, verbose=verbose)
                    ...
                    for heuristic_partial in [True,False]:
                        ...
                        f = io.StringIO()
                        with contextlib.redirect_stderr(f):
                            rules, constraints = Synchronizer.fit(dataset=dataset, complete=complete, verbose=verbose)
