...
class GULA_benchmark_tests(unittest.TestCase):
    """
    ...
    def test_mammalian(self):
        print(">> GULA benchmark <mammalian>:")
    ...
    def test_fission_yeast(self):
        print(">> GULA benchmark <fission_yeast>:")
    ...
    def test_budding_yeast(self):
        print(">> GULA benchmark <budding_yeast>:")
    ...
    def _test_arabidopsis(self):
        print(">> GULA benchmark <arabidopsis>:")
